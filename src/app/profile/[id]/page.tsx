      ...
      <div>
        <div className="flex gap-2 mb-6">
          ...
          <Link
            ...
            className="inline-flex items-center rounded-full border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50"
          >
            我的评论
          </Link>
        </div>
        ...
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-900">我的帖子</h2>
          {posts.length === 0 ? (
        ...
        <div className="space-y-4 mt-8">
          <h2 className="text-lg font-semibold text-gray-900">我的评论</h2>
          {comments.length === 0 ? (
            <p className="text-sm text-gray-500 py-8 text-center">
              暂无评论
            </p>
