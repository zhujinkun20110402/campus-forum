...
const PUBLIC_PATHS = ["/", "/about", "/auth/signin", "/auth/register"]
...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|favicon.ico|images/|avatars/|sw\\.js|manifest\\.(?:json|webmanifest)|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)",
  ],
}
